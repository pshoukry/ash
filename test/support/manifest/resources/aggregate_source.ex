...
defmodule Ash.Test.Manifest.AggregateSource do
  ...
  attributes do
    uuid_primary_key :id
    attribute :first_meta, Ash.Test.Manifest.AggregateFirstMeta, public?: true
    attribute :list_meta, Ash.Test.Manifest.AggregateListMeta, public?: true
  ...
  aggregates do
    ...
    first :child_list_meta, :children, :nested_list_meta
  end
